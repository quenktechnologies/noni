...
describe("string", () => {
  describe("camelcase", () => {
    it("should remove underscores and dashes", () => {
      assert(camelcase("this_is_our-camel")).equal("thisIsOurCamel");
    });
    ...
    it("should recognize dashes,underscores,dots,spaces", () => {
      assert(
        camelcase("This_haS-Dashes_and__underscores sPaces  even.dots... !")
      ).equal("thisHasDashesAndUnderscoresSpacesEvenDots!");
    });

    it("should return an empty string when only seperators", () => {
      assert(modulecase(" -___-  -")).equate("");
    });
  });

  describe("classcase", () => {
    it("should remove underscores and dashes", () => {
      assert(classcase("this_is_our-camel")).equal("ThisIsOurCamel");
    });
    ...
    it("should recognize dashes,underscores,dots,spaces", () => {
      assert(
        classcase("This_haS-Dashes_and__underscores sPaces  even.dots... !")
      ).equal("ThisHasDashesAndUnderscoresSpacesEvenDots!");
    });
  ...
  describe("modulecase", () => {
    it("should remove underscores and dashes", () => {
      assert(modulecase("this_is_our-camel")).equal("this-is-our-camel");
    });
    ...
    it("should recognize dashes,underscores,dots,spaces", () => {
      assert(
        modulecase("This_haS-Dashes_and__underscores sPaces  even.dots... !")
      ).equal("this-ha-s-dashes-and-underscores-s-paces-even-dots-!");
    });

    it("should recognize capital letters", () => {
      assert(modulecase("WorkingCapitalClass")).equate("working-capital-class");
    });
  ...
  describe("capitalize", () => {
    it("should work", () => {
      assert(capitalize("this is capitalized")).equal("This is capitalized");
    });
  ...
  describe("uncapitalize", () => {
    it("should work", () => {
      assert(uncapitalize("This is uncapitalized")).equal(
        "this is uncapitalized"
      );
    });
  ...
  describe("interpolate", () => {
    it("interpolates a string", function () {
      assert(interpolate("My name is {name}", { name: "Kissoon" })).equal(
        "My name is Kissoon"
      );
    });
    ...
    it("handles dot notation", function () {
      assert(
        interpolate("My name is {user.name.first}.", {
    ...
    it("applies the transform", () => {
      assert(interpolate("1 + {foo}", {}, { transform: () => "1" })).equal(
        "1 + 1"
      );
    });

    it("allows the getter to be overridden", () => {
      assert(interpolate("1 + {foo}", {}, { getter: () => "1" })).equal(
        "1 + 1"
      );
    });
  });
  ...
  describe("propercase", () => {
    ...
    it("should not change numbers etc", () => {
      assert(propercase("Abun 353-$pg and huiXsa !70")).equal(
        "Abun 353-$pg And Huixsa !70"
      );
    });
  });
  ...
  describe("alhpanumeric", () => {
    it("should omit non alpha-numeric characters", () => {
      assert(alphanumeric("omega22 fiber_glass")).equate("omega22fiberglass");
    });
  });
});
