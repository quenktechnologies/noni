...
describe('string', () => {
    ...
    describe('modulecase', () => {
        ...
        it('should recognize capital letters', () => {
            assert(modulecase('WorkingCapitalClass')).equate(
    ...
    describe('capitalize', () => {
        it('should work', () => {
            assert(capitalize('this is capitalized')).equal(
                'This is capitalized'
            );
        });
    ...
    describe('alhpanumeric', () => {
        it('should omit non alpha-numeric characters', () => {
            assert(alphanumeric('omega22 fiber_glass')).equate(
                'omega22fiberglass'
            );
        });
    });
