    ...
    () => {
        describe('Functor', () => {
            ...
            it('should obey the composition law', () =>
                assert(functor.composition<A>(pure)(eq)(map)(map)(value)).equal(
                    true
                ));
        });
        ...
        describe('Apply', () => {
            it('should obey the composition law', () =>
                assert(apply.composition<A>(pure)(eq)(map)(map)(value)).equal(
                    true
                ));
        });
        ...
        describe('Monad', () => {
            it('should obey the left identity law', () =>
                assert(monad.leftIdentity<A>(pure)(eq)(bind)(value)).equal(
                    true
                ));
        });
    };
