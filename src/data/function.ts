...
export const compose =
  <A, B, C>(f: Function<A, B>, g: Function<B, C>) =>
  (a: A) =>
    g(f(a));
...
export const compose3 =
  <A, B, C, D>(f: Function<A, B>, g: Function<B, C>, h: Function<C, D>) =>
  (a: A) =>
    h(g(f(a)));
 ...
 */
export const apply = <A, B, C>(f: (a: A, b: B) => C, a: A) => curry(f)(a);

/**
 * apply3 is partial application for a function of 3 arity.
 */
export const apply3 = <A, B, C, D>(f: (a: A, b: B, c: C) => D, a: A, b: B) =>
  curry3(f)(a)(b);
