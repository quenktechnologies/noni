    ...
    Future.prototype._fork = function (value, stack, onError, onSuccess) {
        ...
        var failure = function (e) {
            if (pending) {
                ...
                console.warn("".concat(_this.tag, ": onError called after task completed"));
                console.warn(e);
            }
        };
        var success = function (val) {
            if (pending) {
                ...
                console.warn("".concat(_this.tag, ": onSuccess called after task completed"));
                console.trace();
            }
        };
 ...
 */
var wrap = function (a) {
    return (String(a) === '[object Future]') ? a : (0, exports.pure)(a);
};
exports.wrap = wrap;
/**
