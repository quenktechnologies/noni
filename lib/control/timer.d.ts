 ...
 */
export declare const debounce: <A>(f: Function<A, void>, delay: number) => Function<A, void>;
/**
 ...
 */
export declare const throttle: <A>(f: Function<A, void>, duration: number) => Function<A, void>;
