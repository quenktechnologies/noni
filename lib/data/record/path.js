...
exports.sanitize = exports.project = exports.map = exports.difference = exports.intersect = exports.unflatten = exports.flatten = exports.unescapeRecord = exports.escapeRecord = exports.unescape = exports.escape = exports.set = exports.getString = exports.getDefault = exports.get = exports.unsafeGet = exports.tokenize = void 0;
/**
 ...
 */
exports.sanitize = function (r) {
    return _1.reduce(r, {}, function (p, c, k) {
        var _a;
        _1.isBadKey(k) ?
            p :
            _1.merge(p, (_a = {},
                _a[k] = _1.isRecord(c) ? exports.sanitize(c) : c,
                _a));
    });
};
