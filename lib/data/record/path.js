...
exports.escapeRecord = function (r) {
    return _escapeRecord(r);
};
var _escapeRecord = function (r) {
    return _1.reduce(r, {}, function (p, c, k) {
        if (Array.isArray(c))
            p[exports.escape(k)] = c.map(_escapeRecord);
...
exports.unescapeRecord = function (r) {
    return _unescapeRecord(r);
};
var _unescapeRecord = function (r) {
    return _1.reduce(r, {}, function (p, c, k) {
        if (Array.isArray(c))
            p[exports.unescape(k)] = c.map(_unescapeRecord);
        else if (typeof c === 'object')
