 ...
 */
exports.listD = function (path) {
    return exports.list(path)
 ...
 */
exports.listDA = function (path) {
    return exports.listD(path).map(function (n) { return n.map(expand(path)); });
};
/**
 * listF reads a directory path and returns a list of all
 * that are files.
 */
exports.listF = function (path) {
    return exports.list(path)
        .map(function (stats) { return record_1.reduce(stats, [], function (p, c, k) {
 ...
 */
exports.listFA = function (path) {
    return exports.listF(path).map(function (n) { return n.map(expand(path)); });
};
